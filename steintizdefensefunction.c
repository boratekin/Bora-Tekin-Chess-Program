...
#include <conio.h>
#include <ctype.h>
char steinitzdefensemainboard[8][8] = {
                    { 'R' , ' ' , ' ' , 'K' , 'Q' , 'B' , 'N' , 'R' },
                    { 'P' , 'P' , 'P' , ' ' , 'P' , 'P' , 'P' , 'P' },
                    { ' ' , ' ' , 'N' , ' ' , ' ' , ' ' , ' ' , ' ' },
                    { ' ' , ' ' , ' ' , 'P' , ' ' , ' ' , ' ' , ' ' },
...
{
printf("RUY LOPEZ STEINITZ DEFENSE!\n");
printf("The Steinitz Defense(or Old Steinitz Defense) is solid defense but passive and cramped.\n");
printf("1.e4-e5\n2.Nf3-Nc6\n3.Bb5-d6\n");
...
int i , j , k ;
    ...
    for( j=0 ; j<8 ; j++ ) { printf( "|| %c " , steinitzdefensemainboard[k][j] ) ; }
    printf( "|| \n" ) ;
    }
